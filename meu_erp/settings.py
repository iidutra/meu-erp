"""
Django settings for meu_erp project.
...
WSGI_APPLICATION = 'meu_erp.wsgi.application'
...
# Se tiver DATABASE_URL (Railway/Postgres), substitui o default
DATABASE_URL = os.environ.get('DATABASE_URL')
if DATABASE_URL:
    DATABASES['default'] = dj_database_url.config(
        default=DATABASE_URL,
        conn_max_age=600,
        ssl_require=False,  # Se o Railway exigir SSL, podemos mudar para True depois
    )
